...
class RestaurantDiscountItem extends StatelessWidget {
  const RestaurantDiscountItem({Key? key, required this.restaurantDiscount})
      : super(key: key);
  final RestaurantDiscount restaurantDiscount;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          Get.toNamed(Routes.discountDetail,
              arguments: {'discount': restaurantDiscount});
        },
        child: Container(
          ...
          child: ListTile(
            ...
            title: Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    restaurantDiscount.name, // Use name from Dish model
                    overflow: TextOverflow.ellipsis,
                    maxLines: 2,
                    style: AppStyles.roboto16semiBold,
                  ),
                  Gap(4),
                  Text(dateConvert(restaurantDiscount.validFrom, restaurantDiscount.validTo), // Use description from Dish model
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                  ...
                  child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(
                            "x${restaurantDiscount.maxUsed}", // Use maxUsed from RestaurantDiscount model
                            style: AppStyles.roboto12regular

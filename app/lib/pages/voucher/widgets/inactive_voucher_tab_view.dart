...
class TabInactiveVoucherView extends StatelessWidget {
  const TabInactiveVoucherView({super.key});
      ...
      child: Column(
        children: [
          Container(
            height: height * 0.7,
            child: FutureBuilder(
              future: controller.inactiveVouchers,
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            onTap: () {},
                            child: VoucherItem(voucher: voucher),
                            // child: Container(
                            //   padding:
                            ...
                            //             children: [
                            //               Text(
                            //                   voucher.remainingUsage.toString(),
                            //                   maxLines: 1,
                            //                   overflow: TextOverflow.ellipsis,

...
import 'package:food_delivery_app/pages/order_manager/order_state_manager/order_state/delivering_order_state.dart';
...
class ProcessingOrderState implements IOrderState {
  ...
  final OrderStatus statusName = OrderStatus.PROCESSING;
  ProcessingOrderState({required this.orderContext});
  @override
  void acceptOrder() {

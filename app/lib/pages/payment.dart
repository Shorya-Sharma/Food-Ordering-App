...
import 'package:food_delivery_app/repository/payment_repository.dart';
import 'package:food_delivery_app/resources/utils/config.dart';
...
class _HomeZaloPayState extends State<HomeZaloPay> {
  ...
  final valueStyle =
      TextStyle(color: Colors.red, fontSize: 18.0, fontWeight: FontWeight.w400);
  String zpTransToken = "";
  String payResult = "";
